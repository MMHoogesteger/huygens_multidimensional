function [J,trnablaJ] = errDescnxyphi_r_three_tang(Nt,rho_f,Nr,G_func,dGdomega_func,params,U_gains,HStar,R,gamma,psi,W,rho_ids,rho_o,res)
...
ak(5,:) = phaseShiftHarmonics(ak(4,:),2*pi/3);
ak(6,:) = phaseShiftHarmonics(ak(4,:),2*pi/3*2);
...
[Jk,nablaJk] = harmonic_n_xyphi_eval_r_fft_with_grad(Nt,ak,omega,G_func,dGdomega_func,params,U_gains,HStar,R,gamma,psi,res);
