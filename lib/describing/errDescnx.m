function [J,trnablaJ] = errDescnx(Nt,rho_f,G_func,dGdomega_func,params,U_gains,HStar,W,rho_ids,rho_o,res)
...
[J1,nablaJ1] = harmonic_n_x_eval(Nt,a1,omega,G_func,dGdomega_func,params,U_gains,HStar,res);
